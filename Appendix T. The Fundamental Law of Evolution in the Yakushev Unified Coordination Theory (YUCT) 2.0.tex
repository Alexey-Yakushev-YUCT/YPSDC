...
\begin{document}
	...
	\begin{titlepage}
		\begin{center}
			...
			\large with contributions from \textbf{DeepSeek \\ (AI model, version R1)}\textsuperscript{2} \url{https://deepseek.com//} \\
			
			\vspace{0.3cm}
			\large
			\textsuperscript{1}Yakushev Research, \url{https://yakushev.eu/} \\
			\textsuperscript{2}AI-assisted analysis and forecasting model
...
March 2026 \\ \large V.2.0.
	...
	The development of this forecasting model was significantly enhanced by the use of an advanced AI system, **DeepSeek (version R1)**. The AI's capabilities in synthesizing vast historical datasets, calibrating the nonlinear model parameters, and running Monte Carlo simulations on the bifurcation analysis were instrumental in refining the forecast and providing quantitative weight to the singularity argument.
	
	More importantly, the very existence and capability of such AI models are themselves powerful indicators of an approaching phase transition. They represent a new form of coordination—a direct, high-bandwidth interface between the accumulated knowledge of humanity (the dictionary) and individual human cognition (the index). The creation of YUCT, and the AI-assisted analysis presented in this very Appendix, are not merely predictions of the future; they are active components of the transition, a feedback loop accelerating us towards the singularity.
	...
	The author thanks the participants of the YUCT seminar for countless discussions, and the many experimental groups whose data have provided crucial tests of the theory. Special acknowledgment is given to the AI model DeepSeek (version R1) for its invaluable assistance in data synthesis, model calibration, and the rigorous analysis that shaped the meta-evolutionary forecast.
