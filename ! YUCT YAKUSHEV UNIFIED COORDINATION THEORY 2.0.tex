...
\hypersetup{
	...
	pdfkeywords={Yakushev Framework, Paradigm shift, Coordination efficiency, D+I•R, Theory of the Organization of Everything, Coordination of All Existence, COAE, Theory of Universal Organization, TOE, YUCT, YPSDC, dictionary manifold, coordination efficiency, emergent spacetime, perihelion precession, gravitational redshift, experimental tests},
	breaklinks=true,
	pdfencoding=auto,
...
% ВСТАВИТЬ ЭТОТ ОБЪЕДИНЁННЫЙ ТЕКСТ:
...
\end{table}
	...
	\textbf{Keywords:} quantum entanglement, principle of locality, relativity, coordination theory, $K_{\mathrm{eff}}$, D+I dictionaries, geometric observers.
